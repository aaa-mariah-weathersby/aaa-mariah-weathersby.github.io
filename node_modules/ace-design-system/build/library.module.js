...
var interopRequireDefault$3 = createCommonjsModule(function (module) {
function _interopRequireDefault(obj) {
  return obj && obj.__esModule ? obj : {
    default: obj
  };
...
unwrapExports(interopRequireDefault$3);
...
var _getDisplayName = interopRequireDefault$3(getDisplayName_1);
...
var __DEV__$2 = "development" !== 'production';
...
function mergeClasses() {
  ...
  return (0, _objectSpread2.default)({}, baseClasses, Object.keys(newClasses).reduce(function (accumulator, key) {
    (0, _warning.default)(baseClasses[key] || noBase, ["Material-UI: the key `".concat(key, "` ") + "provided to the classes property is not implemented in ".concat((0, _getDisplayName.default)(Component$$1), "."), "You can only override one of the following: ".concat(Object.keys(baseClasses).join(','))].join('\n'));
    (0, _warning.default)(!newClasses[key] || typeof newClasses[key] === 'string', ["Material-UI: the key `".concat(key, "` ") + "provided to the classes property is not valid for ".concat((0, _getDisplayName.default)(Component$$1), "."), "You need to provide a non empty string instead of: ".concat(newClasses[key], ".")].join('\n'));
...
var _deepmerge = interopRequireDefault$1(require$$3);
...
var _isPlainObject = interopRequireDefault$1(isPlainObject);
...
var _shape = interopRequireDefault$1(shape_1);

var _spacing = interopRequireDefault$1(spacing_1);
...
var _mergeClasses = interopRequireDefault$1(mergeClasses_1);
    ...
    function (_React$Component) {
      ...
      (0, _createClass2.default)(WithStyles, [{
        ...
        value: function attach(theme) {
          ...
          if (sheetManagerTheme.refs === 0) {
            ...
            if ("development" !== 'production' && !meta) {
              ...
              (0, _warning.default)(typeof meta === 'string', ['Material-UI: the component displayName is invalid. It needs to be a string.', "Please fix the following component: ".concat(Component$$1, ".")].join('\n'));
            }
        ...
        value: function render() {
          ...
          return _react.default.createElement(Component$$1, (0, _extends2.default)({}, more, {
...
var _reactLifecyclesCompat = Object.freeze({
	polyfill: polyfill
});
  ...
  createClass(Button, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(ButtonBase$2, {
          disableRipple: true,
          ...
          children: React.createElement(ButtonLabel, {
...
var Helper = function Helper(props) {
    return props.active !== false ? React.createElement(
        'div',
...
export { Button$2 as Button, Input$2 as Input, Helper };
